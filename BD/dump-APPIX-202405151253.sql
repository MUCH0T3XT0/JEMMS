...
INSERT INTO `RIESGO` VALUES (1,1,1,3,2,'Realizar reuniones detalladas con el cliente','Incomprensión de los requisitos del cliente '),(2,2,2,2,2,'Establecer plazos claros y roles para entrega de contenido.','Retrasos en la entrega del contenido '),(3,3,1,2,2,'Definir un alcance claro y limitar las revisiones del diseño.','Cambios frecuentes en el diseño  '),(4,4,3,3,1,'Realizar pruebas de compatibilidad al inicio.','Problemas de compatibilidad de plugins '),(5,5,3,3,1,'Aplicar estándares de seguridad y realizar actualizaciones.','Problemas de seguridad en el sitio web  '),(6,6,3,3,2,'Validar integraciones y tener proveedores de respaldo.','Fallos en la integración de pasarelas de pago '),(7,7,4,2,1,'Monitorear y ajustar el presupuesto continuamente.','Aumento inesperado en los costos del proyecto '),(8,8,3,3,1,'Estrategias de respaldo y recuperación ante desastres.','Pérdida de datos o fallo de hosting  '),(9,9,2,2,2,'Establecer expectativas y procesos claros de aprobación.','Retrasos en la aprobación del cliente '),(10,10,3,2,2,'Mantenerse actualizado con las últimas versiones y soporte.','Dificultades técnicas con WordPress o WooCommerce '),(11,11,5,3,2,'Gestionar la carga de trabajo y los recursos adecuadamente','Sobrecarga de trabajo del equipo de diseño '),(12,12,3,3,2,'Capacitar al equipo o contratar talento especializado','Falta de experiencia en tecnologías específicas '),(13,13,1,3,3,'Implementar un sistema estructurado de gestión de cambios.','Inadecuada gestión del cambio '),(14,14,4,2,1,'Tener alternativas y planes de contingencia.','Interrupciones en la cadena de suministro digital '),(15,15,3,2,2,'Aplicar técnicas SEO desde el inicio del proyecto','Problemas de SEO y visibilidad en buscadores '),(16,16,5,3,2,'Crear planes de transición por si pasa esto','Cambio de persona responsable durante y despues del proyecto  '),(17,17,1,3,3,'Mantener un proceso de gestión de cambios robusto','Cambios en los requisitos del software'),(18,18,4,3,2,'Asegurar disponibilidad de recursos y personal cualificado.','Falta de recursos técnicos'),(19,19,3,2,3,'Implementar pruebas exhaustivas y QA constante.','Problemas técnicos y bugs en el desarrollo'),(20,20,3,3,1,'Realizar auditorías tecnológicas y actualizaciones regulares.','Tecnología obsoleta o inadecuada '),(21,1,5,3,3,'tratarlo con amor','jaime no se sabe la de chambear'),(22,1,4,2,3,'menos tiempo','mike come de mas');
...
INSERT INTO `USUARIO` VALUES (1,'Miguel Angel','Esquivel','Uribe','mikesquivel2004@gmail.com','mike',0),(2,'Sofia','Suarez','Osorio','a01277695@tec.mx','sofia',1),(3,'Emiliano','Lara','Valdivia','a01276258@tec.mx','emiliano',0),(4,'Jaime','Ruiz','Trujillo','a01276139@tec.mx','jaime',0),(5,'Marianna','Ramirez','Juarez','a01276193@tec.mx','marianna',1),(6,'Ana','chango','banana','a01277614@tec.mx','ana',0);
...
-- Dump completed on 2024-05-18 22:22:58
